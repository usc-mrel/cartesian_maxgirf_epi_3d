...
%% Get imaging parameters from an XML header
header_fieldmap = ismrmrd.xml.deserialize(dset.readxml);

%--------------------------------------------------------------------------
% Encoding Space (Nkx, Nky, Nkz)
%--------------------------------------------------------------------------
Nkx_fieldmap = header_fieldmap.encoding.encodedSpace.matrixSize.x; % number of readout samples in k-space
Nky_fieldmap = header_fieldmap.encoding.encodedSpace.matrixSize.y; % number of phase-encoding steps in k-space
Nkz_fieldmap = header_fieldmap.encoding.encodedSpace.matrixSize.z; % number of slice-encoding steps in k-space

%--------------------------------------------------------------------------
% Recon Space (Nx, Ny, Nz)
%--------------------------------------------------------------------------
Nx_fieldmap = header_fieldmap.encoding.reconSpace.matrixSize.x; % number of samples in image space (RO)
Ny_fieldmap = header_fieldmap.encoding.reconSpace.matrixSize.y; % number of samples in image space (PE)
Nz_fieldmap = header_fieldmap.encoding.reconSpace.matrixSize.z; % number of samples in image space (SL)
